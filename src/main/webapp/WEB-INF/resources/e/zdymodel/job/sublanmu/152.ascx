...
<%if(IsSearch==0){conn.Open();%><ul class="zhaopinxx"><% 
...
%>
<li>
<div class="zp_tit"><%=dr["title"].ToString()%></div>
<div class="zp_zz">岗位职责：</div>
<div class="zz_com"><%=dr["content"].ToString()%></div>
<div class="zp_yq">岗位要求：</div>
<div class="yq_com"><%=dr["pa_gwyq"].ToString()%></div>
</li>
<%
 }
%>
